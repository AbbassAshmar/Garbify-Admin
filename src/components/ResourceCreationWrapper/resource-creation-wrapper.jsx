...
export default function ResourceCreationWrapper({children, endpointURL, handleData, resource, formResetClicked, setFormResetClicked, setInputErrors}){
    ...
    return (
        <>
            {showSuccessPopUP && <ResourceActionSuccessPopUp buttonText={"View "+resource+"s"} redirect={"/"+resource+"s"} message={`${resource} created successfully`} show={showSuccessPopUP} setShow={setShowSuccessPopUp}/>}
